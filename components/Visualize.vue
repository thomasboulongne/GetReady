<template>
	<div class="visualize categoryPage">
		...
		<div class="section">
			...
			<page-intro-comp :intro="content['Sections'][0]['Intro']" :definition="false"></page-intro-comp>
			<detailed-blocks-comp :blocks="content['Sections'][0]['POV']"></detailed-blocks-comp>
		</div>
		<div class="section">
			<h2>
